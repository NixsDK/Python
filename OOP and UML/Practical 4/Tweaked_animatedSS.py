...
def createSSandAnimate():
   ...
   m = Planet("Mercury", 190.5, 1000, .25, 0, 2, "blue")
   ss.addPlanet(m)

   m = Planet("Earth", 470.5, 5000, 0.3, 0, 2.0, "green")
   ss.addPlanet(m)

   m = Planet("Mars", 500, 9000, 0.5, 0, 1.63, "red")
   ss.addPlanet(m)

   m = Planet("Jupiter", 1000, 49000, 0.7, 0, 1, "black")
   ss.addPlanet(m)
